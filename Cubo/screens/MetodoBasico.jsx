  ...
  return (
    <SafeAreaView style={estilos.SafeArea}>
      ...
      <ScrollView style={estilos.conteudoScroll} contentContainerStyle={estilos.conteudoCentralizado} ref={scrollRef}>
        ...
        <Text style={estilos.texto}>Caso você tenha um cubo de figuras e, ao resolver, se deparou com os meios rotacionados e não sabe resolver, confira agora tambem os Cubos de Figuras:</Text>
